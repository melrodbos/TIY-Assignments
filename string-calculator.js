...
expect(minus("seven", "zero")).to.equal(7);
expect(minus("seven", "one")).to.equal(6);
expect(minus("seven", "two")).to.equal(5);
expect(minus("seven", "three")).to.equal(4);
expect(minus("seven", "four")).to.equal(3);
expect(minus("seven", "five")).to.equal(2);
expect(minus("seven", "six")).to.equal(1);
expect(minus("seven", "seven")).to.equal(0);
expect(minus("seven", "eight")).to.equal(-1);
expect(minus("seven", "nine")).to.equal(-2);

expect(minus("eight", "zero")).to.equal(8);
expect(minus("eight", "one")).to.equal(7);
expect(minus("eight", "two")).to.equal(6);
...
expect(minus("nine", "zero")).to.equal(9);
expect(minus("nine", "one")).to.equal(8);
expect(minus("nine", "two")).to.equal(7);
expect(minus("nine", "three")).to.equal(6);
expect(minus("nine", "four")).to.equal(5);
expect(minus("nine", "five")).to.equal(4);
expect(minus("nine", "six")).to.equal(3);
expect(minus("nine", "seven")).to.equal(2);
